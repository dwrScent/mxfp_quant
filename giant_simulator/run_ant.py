...
print("olive_weight", bf_e_cycles_ant)
print("olive_energy", bf_e_energy_ant)
...
bf_e_results = check_pandas_or_run(bf_e_sim1, bf_e_sim_sweep_df_1, bf_e_sim_sweep_csv_1, batch_size=batch_size, bench_type='ant', weight_stationary=True)
bf_e_results = bf_e_results.groupby('Network',as_index=False).agg(np.sum)
...
print("ant_weight", bf_e_cycles_ant_weight)
print("ant_energy", bf_e_energy_ant_weight)
...
bf_e_cycles_bit = copy.deepcopy(bf_e_cycles_ant)
bf_e_energy_bit = copy.deepcopy(bf_e_energy_ant)
...
print("ola_weight", bf_e_cycles_ola)
print("ola_energy", bf_e_energy_ola)
...
print("ada_weight", bf_e_cycles_ada)
print("ada_energy", bf_e_energy_ada, np.shape(bf_e_energy_ada))
...
bf_e_cycles_bis = copy.deepcopy(bf_e_cycles_ant)
bf_e_energy_bis = copy.deepcopy(bf_e_energy_ant)
...
for i in range(len(bf_e_cycles_ant)):
    ...
    cyc_4 = cyc_4 / cyc_4
    cyc_4_mean += cyc_4
    print("cycle1_olive", cyc_1, " cycle5_ant", cyc_5, " cycle3_ola", cyc_3, " cycle4_ada", cyc_4 )
...
ff.write(wr_line)
wr_line = ""
print("tttt", "%0.2f, %0.2f, %0.2f, %0.2f, %0.2f, %0.2f, " %(cyc_1_mean, cyc_5_mean, cyc_2_mean, cyc_3_mean, cyc_6_mean, cyc_4_mean))
print()
...
for i in range(len(bf_e_cycles_ant)):
    ...
    print("debug before", energy_data_1, energy_data_total)
    ...
    print("debug after", energy_data_1, energy_data_total)
