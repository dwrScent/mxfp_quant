...
parser.add_argument(
        "--w_mode", type=str, choices=["mxfp", "nvfp", "mxem", "mxes", "nvem", "nves", "hif4", "hifem", "hifes", "nvfpe5", "nvfpm4", "nvfpm5"], default=None
)
parser.add_argument("--a_bit", type=int, default=16)
parser.add_argument(
    "--a_mode", type=str, choices=["mxfp", "nvfp", "mxem", "mxes", "nvem", "nves", "hif4", "hifem", "hifes", "nvfpe5", "nvfpm4", "nvfpm5"], default=None
)
