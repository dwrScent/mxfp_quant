...
parser.add_argument(
        "--w_mode", type=str, choices=["mxfp", "nvfp", "mxem", "mxes", "nvem", "nves", "nvesem2", "nvesm", "nvesm2", "nvint4", "nvintesm2", "hif4", "hifem", "hifes", "nvgt4"], default=None
)
parser.add_argument("--a_bit", type=int, default=16)
parser.add_argument(
    "--a_mode", type=str, choices=["mxfp", "nvfp", "mxem", "mxes", "nvem", "nves", "nvesem2", "nvesm", "nvesm2", "nvint4", "nvintesm2", "hif4", "hifem", "hifes", "nvgt4"], default=None
)
