...
CUDA_VISIBLE_DEVICES=0 ./scripts/llama2_run_load.sh 7 wikitext 0 giant int 64 4 4 1 10
...
CUDA_VISIBLE_DEVICES=0,1,2,3 ./scripts/llama3_run.sh 70 wikitext 0 ant float 32 w4a4k16v16 w-base-a-base quant

CUDA_VISIBLE_DEVICES=0 ./scripts/llama3_run.sh 8 wikitext 0 mxfp int 32 w-1a4k16v16 w-base-a-base quant fp16
CUDA_VISIBLE_DEVICES=0 ./scripts/llama3_run.sh 8 wikitext 0 mxfp int 32 w4a4k16v16 w-base-a-base quant mxfp_base
