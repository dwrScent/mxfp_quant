...
module nvesm2_group_scale (
    ...
    wire [16*31-1:0] abs_bus;
    wire [30:0] max_abs;
    wire        max_valid;
    wire [7:0]  max_exp8  = max_abs[30:23];
    wire [22:0] max_frac23 = max_abs[22:0];
    ...
    wire [36:0] max_prod_q12 = max_sig24 * RECIP_E2M1_MAX_NORM_Q12;

    reg        conv_v1;
    reg        conv_zero_v1;
    reg        conv_inf_v1;
    reg signed [10:0] conv_exp_unb_v1;
    reg [36:0] conv_prod_q12_v1;
