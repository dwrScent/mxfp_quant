...
class Qwen2Attention_mxfp(nn.Module):
...
class Qwen2DecoderLayer_mxfp(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = Qwen2Attention_mxfp(
...
class Qwen2Model_mxfp(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            config.num_hidden_layers,
            lambda prefix: Qwen2DecoderLayer_mxfp(config=config,
                                             cache_config=cache_config,
                                             quant_config=quant_config,
                                             prefix=prefix),
...
class Qwen2ForCausalLM_mxfp(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.quant_config = quant_config
        self.model = Qwen2Model_mxfp(vllm_config=vllm_config,
...
class Qwen2EmbeddingModel_mxfp(nn.Module, SupportsLoRA, SupportsPP):
    packed_modules_mapping = {
        "qkv_proj": [
            "q_proj",
            "k_proj",
